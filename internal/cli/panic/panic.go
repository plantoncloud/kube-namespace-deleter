...
import (
	"fmt"
	"github.com/plantoncloud/kube-namespace-deleter/internal/cli/version"
	"os"
	"runtime"
	"runtime/debug"
)
...
func Handle(finished *bool) {
	if panicPayload := recover(); !*finished {
		...
		fmt.Fprintln(os.Stderr, "The Kube Namespace Deleter encountered a fatal error. This is a bug!")
		fmt.Fprintln(os.Stderr, "We would appreciate a report: https://github.com/plantoncloud/kube-namespace-deleter/issues/")
